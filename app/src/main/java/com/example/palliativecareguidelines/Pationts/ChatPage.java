...
import com.example.palliativecareguidelines.modules.MessageAdapter;
import com.example.palliativecareguidelines.modules.Messages;
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                loadingBar.dismiss();
                                Toast.makeText(ChatPage.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    ...
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(ChatPage.this,"Error:",Toast.LENGTH_SHORT).show();
                                    }
